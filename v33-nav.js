document.addEventListener('DOMContentLoaded',()=>{
  ...
  if(splash){
    splash.innerHTML='<img class="manthos-splash-art" src="assets/navigation/Splash%20screen.png?v=3418" alt="Manthos Habit Tracker">';
  ...
  if(logo){logo.setAttribute('role','button');logo.setAttribute('aria-label','Terug naar cockpit');logo.setAttribute('title','Terug naar cockpit');logo.tabIndex=0;const goHome=()=>{if(typeof home==='function')home();else if(typeof page==='function')page('home')};logo.addEventListener('click',goHome);logo.addEventListener('keydown',e=>{if(e.key==='Enter'||e.key===' '){e.preventDefault();goHome()}})}
  ...
  loadCss('./v331-install.css','v331-install');loadJs('./v331-install.js','v331-install');loadCss('./v34-paths.css','v34-paths');loadJs('./v34-paths.js','v34-paths');loadCss('./v34-core.css','v34-core');loadJs('./v34-core.js','v34-core');setTimeout(()=>loadJs('./v34-fixes.js?v=3418','v34-fixes'),80);
});